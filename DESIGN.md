...
> **How this file is used in Firefly**
>
> This is Linear's design system guide (from [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md)).
> Firefly adopts Linear's **design discipline** — typography, density, precision,
> refined component sizing — but **keeps its own palette**:
>
> - **Light theme** (white / off-white backgrounds), not Linear's near-black
> - **Dark green `#163300` accent**, not Linear's indigo-violet `#5e6ad2`
> - Existing text/border/muted colors: `#2E3338`, `#B4BCC8`, `#E8EAED`, `#F4F5F6`
>
> When applying this guide, translate Linear's color tokens back to Firefly's
> light palette, but **follow Linear's rules for everything else**: Inter Variable
> with `"cv01", "ss03"` OpenType features, weight 510 as UI emphasis, negative
> letter-spacing on display text, 6–8px card radius, tight spacing rhythm,
> subtle borders instead of heavy ones.
>
> The rest of this file is Linear's guide, unmodified, for reference.
